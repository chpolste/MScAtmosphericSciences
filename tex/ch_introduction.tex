...
Although not all papers deal with temperature/humidity and some use infrared
radiation instead of microwaves, the methods of retrieval are the same and
all papers are considered here when discussing methodology.
...
\startsection[title={A Short Review of Research}]
