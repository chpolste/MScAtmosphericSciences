...
space-bourne instruments are the main sources of information about the vertical
...
\startsection[title={Properties and Applications of Microwave Radiometers}]
    ...
    launches of balloon-bourne in-situ instruments and provides a much higher
    ...
    affect suitabiliy for deployment in a long-term unattended mode
    ...
    horizontal drift during their ascent and need a substantial amout of time
    ...
    which stongly depend on accurate vertical profiles of temperature, humidity
    ...
    activity and fog. \cite[Chan2013] analysed the flucutations of brightness
