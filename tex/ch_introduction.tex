...
\startsection[title={Properties and Applications of Microwave Radiometers}]
    ...
    A radiometer is a passive remote sensing instrument. It can therefore safely
    ...
    \cite[authoryears][Guldner2001]. MWRs are much cheaper to operate than regular
    launches of balloon-borne in-situ instruments and provide a much higher
    ...
    Common calibration methods for microwave radiometers are the tipping curve
    ...
    global coverage but pass a fixed location twice only after long intervals
    ...
    boundary layer processes is essential for the development of accurate
    ...
    which depend on accurate vertical profiles of temperature, humidity
...
\startsection[title={Prior Work in Innsbruck}]
    ...
    The Institute of Atmospheric and Cryospheric Sciences (ACINN) at the University of
    ...
    in Innsbruck is comparable to that of radiometers in flat
    ...
    for specialized retrievals, categorizing the atmospheric state for example by
    stability and applying specifically trained regression models.
    ...
    combined with specialized retrievals allowed a better retrieval of elevated
...
\startsection[title={Objectives and Outline}]
    ...
    However, computational costs of such retrievals are higher and any data used in the
