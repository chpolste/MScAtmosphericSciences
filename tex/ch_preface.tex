...
only final results of interest? I have generally sticked to presenting final,
polished results instead of each step of the research process. However I
included at least some (negative) experiences from the \quote{journey} that
I took with this thesis at appropriate locations in the text. Because I refrain
from writing in first person perspective in a scientific work, I would like to
provide some personal thoughts and additional context here:
...
That actually seems to be the theme of this work: reinventing the wheel in
order to get to know all aspects of the retrieval problem in depth.  While this
is not best scientific practice, I think a Master's thesis is a good place for
such an approach without wasting much of anyone's time except possibly mine.
