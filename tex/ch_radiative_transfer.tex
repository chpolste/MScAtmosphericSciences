...
\startsection[title=Implementation of a Numerical Model]

    Presentation of a custom implementation of a line-by-line model. Based on
    absorption models by \cite[Liebe1993] for gaseaous absorption and
...
\startsection[title={Characterizing Errors},reference={ch:rtm_errors}]
