...
\startsection[title=Atmospheric Extinction and Absorption Models]

    To calculate brightness temperatures with \ineq{rte_solution} atmospheric
    absorption/emission coefficients need to be determined. The review of
    \cite[Westwater2004] includes a chapter on atmospheric absorption in the
    microwave region from 20 to 200 GHz. Its main features are repeated here
    with some additions.
    ...
    The three main contributing constituents in the atmosphere are oxygen,
    water vapor and liquid water. A typical absorption spectrum of an
