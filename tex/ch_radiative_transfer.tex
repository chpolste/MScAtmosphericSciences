...
\startsection[title={Characterization of Errors},reference={ch:rtm_errors}]
    ...
    timeseries of radiometer measurements it should be regularly tested if
    the applied offset is stationary over time. Changes of the offset value
    are especially likely after a recalibration of the radiometer
    \cite[authoryears][Lohnert2012].
