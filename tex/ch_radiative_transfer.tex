...
\startsubsection[title=Fast Absorption Prediction]
    ...
    time. It also simplifies the task of model linearization greatly (section
    \in[ch:linearization]). The {\FAP} is chosen to be a polynomial of the
    state vector variables $p$, $T$, $\LNQ$ (although with some prior
...
\startsubsection[title={Model Comparison},reference={ch:model_comparison}]
    ...
    comparison also allows a quantification of spectroscopy errors which are an
    important part of the forward model error covariance
