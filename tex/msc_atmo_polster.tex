...
\setuppublications[criterium=text,alternative=apa,sorttype=bbl,refcommand=authoryear]
...
\startbodymatter
    ...
    \startchapter[title=Retrieval Theory]
        \input ch_retrieval
    \stopchapter

    \startchapter[title=Instrument and Data]
        \input ch_instrument
    \stopchapter
