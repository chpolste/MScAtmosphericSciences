% All custom styles etc. are given CamelCase names

\define\DocTitle{Towards a Physical Retrieval of Thermodynamic Atmospheric Profiles from a Ground-based Microwave Radiometer}
\define\DocTitleFooter{Towards a Physical Retrieval of Thermodynamic Atmospheric Profiles ...}
\define\DocSubtitle{}
...
\definefont[ChapterFont][dejavusans at 20pt]
...
\definealternativestyle[FigureCaptionStyle][\FigureCaptionStyle]
...
\setuppublications[criterium=text,alternative=apa-de,sorttype=bbl,refcommand=authoryear]
\setuppublicationlist[artauthoretallimit=40]
\setupcite[authoryears][pubsep={; },lastpubsep={; },inbetween={ }]
...
\startsectionblockenvironment[appendix]
    ...
    \setupfootertexts[{\FooterFont {\DocTitleFooter}}]
                     ...
                     [{\FooterFont Master's Thesis of {\Author} (2016)}]
    \setupbackgrounds[footer][text][topframe=on]
    \setuphead[section][conversion=R]
    \setupwhitespace[medium]
    \setupinterlinespace[line=1.5em]
    \resetnumber[figure]
    \setupcaptions[figure][numberconversion=Romannumerals]
\stopsectionblockenvironment
...
% Acknowledgements
\definesectionblock[AcknowledgementSectionBlock][,]
\setupsectionblock[AcknowledgementSectionBlock][page=right]
\startsectionblockenvironment[AcknowledgementSectionBlock]
...
\startsectionblock[CoverSectionBlock]
    ...
    Towards a Physical Retrieval of \blank[5mm]
    Thermodynamic Atmospheric Profiles from a \blank[5mm]
...
\startbodymatter
    ...
    \startchapter[title=Radiative Transfer Modelling]
        \input ch_radiative_transfer
    \stopchapter

    \startchapter[title=Retrievals of Synthetic Data]
        \input ch_synthetic_data
    \stopchapter

    \startchapter[title=A Case Study with Real Observations]
        \input ch_real_data
    \stopchapter

    \startchapter[title=Outlook]
        \input ch_outlook
    \stopchapter
...
\startsectionblock[AcknowledgementSectionBlock]
    \page[empty,force]

    \startsubject[title=Acknowledgements,page=yes]
        Mathias, ...
