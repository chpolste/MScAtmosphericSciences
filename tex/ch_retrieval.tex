...
\startsection[title=Linear Regression]
    ...
    model parameters. A full description of the predictive distribution appears
    to be very useful for the estimation of uncertainty in predictions. But
    care has to be taken in its interpretation. 
    ...
    \placefigure[top][fig:bayesian_regression]
        ...
        model uses 7 Gaussian basis functions between -3 and 3.}
