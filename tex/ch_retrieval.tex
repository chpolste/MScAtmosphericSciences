...
\startsection[title={Bayesian Statistics}]
    ...
    a Bayesian update of the distribution of $x$ in light of some data $y$. At
...
\startsection[title=Other Retrieval Techniques]
    ...
    Quick mention of neural networks and the whole of regression methods from
    the field of machine learning. PCA for data reduction.
