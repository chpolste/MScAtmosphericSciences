...
\startsection[title=Linear Regression]
    ...
    \startformula
        \RLIKELIHOOD = \prod_{i=1}^{m} \GAUSS{x_i}{\VECWT \VECPHI(\VECY_i)}{\BETAI}
    \stopformula
    ...
    \startalign[n=2,align={right,left}]
        ...
        \NC = \NC
            \int_{\REALS^{n+1}} \GAUSS{x}{\VECWT \VECPHI(\VECY)}{\BETAI} \,
    ...
    \startformula
        \RPREDICT = \GAUSS{x}{\VECPHI(\VECY)^\top \MEANVEC}{\BETAI + \VECPHI(\VECY)^\top \COVMATI \VECPHI(\VECY)}
    \stopformula
