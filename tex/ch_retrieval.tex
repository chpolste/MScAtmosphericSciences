...
\startsection[title=The Multivariate Gaussian Distribution]
    ...
    \startsubsection[title={Bayes' Theorem for Gaussians},reference=ret_bayes_gauss]
        ...
        \startalign[n=2,align{right,left}]
            \NC -2 \ln(\LIKELIHOOD) = \NC \GAUSSEXP{\VECY}{\FWDJAC\VECX - \VECB}{\COVMATY} + c_1 \NR
            \NC -2 \ln(\PRIOR) = \NC \GAUSSEXP{\VECX}{\MEANVECA}{\COVMATX} + c_2 \NR
        \stopalign
        \stopformula
        ...
        \startalign[n=2, align{right,left}]
            ...
            \NC = \NC
                ...
                \NR
            \NC \NC
                - \mathbox{cornflowerblue}{\VECX^\top \FWDJAC^\top \COVMATY^{-1} \VECY}
                + \mathbox{yellowgreen}{\VECX^\top \FWDJAC^\top \COVMATY^{-1} \FWDJAC \VECX}
                + \mathbox{cornflowerblue}{\VECX^\top \FWDJAC^\top \COVMATY^{-1} \VECB}
                \NR
            \NC \NC
            ...
            \NC \NC
                ...
                - \mathbox{cornflowerblue}{\VECX^\top \COVMATX^{-1} \MEANVECA}
